...
class FullFrameRect(var program: Texture2DProgram) {
    ...
    companion object {
        ...
        private val FULL_RECTANGLE_COORDS_LOGO = floatArrayOf(
        ...
        private val FULL_RECTANGLE_BUF_LOGO: FloatBuffer = ByteBuffer.allocateDirect(FULL_RECTANGLE_COORDS_LOGO.size * 4)
        ...
        private val LOGO_TEX_COORDS = floatArrayOf(
            0.0f, 1.0f,  // Bottom left (flipped y-coordinate)
            1.0f, 1.0f,  // Bottom right (flipped y-coordinate)
            0.0f, 0.0f,  // Top left (flipped y-coordinate)
            1.0f, 0.0f,  // Top right (flipped y-coordinate)
        )
