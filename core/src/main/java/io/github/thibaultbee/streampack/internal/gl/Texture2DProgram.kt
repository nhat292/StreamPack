...
class Texture2DProgram {
    ...
    fun draw(
        ...
        Matrix.scaleM(logoMvpMatrix, 0, 0.13f, 0.2f, 1f)  // Scale down logo
        ...
        // Create text
        if (textTextureId == -1) {
            textTextureId = createTextTexture( "1-0", 25f, Color.WHITE)
        }
        ...
        Matrix.translateM(textMvpMatrix, 0, -0.9f, 0.0f, 0f)  // Top-left corner
